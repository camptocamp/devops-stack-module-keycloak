...
- [[provider_vault]] <<provider_vault,vault>> (>= 3)
...
- https://registry.terraform.io/providers/hashicorp/vault/latest/docs/resources/generic_secret[vault_generic_secret.keycloak_secrets] (resource)
